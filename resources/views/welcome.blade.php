...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>DialogFlow Project-School</title>
        ...
        <div class="container py-3">
            <header>
                ...
                <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none">
                    <span class="fs-4">Dialogflow Project</span>
                </a>
                ...
                <h1 class="display-4 fw-normal text-body-emphasis">Consulta aqui</h1>
                <p class="fs-5 text-body-secondary">Nuestros variedad de productos disponibles</p>
                </div>
            </header>
                        ...
                        <div class="card mb-4 rounded-3 shadow-sm text-center">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-center">
                                <iframe
                                    ...
                                    width="350"
                                    height="400"
                                    src="https://console.dialogflow.com/api-client/demo/embedded/a91687cc-b3d3-4bfa-b1bc-e19ffb482f90">
                                </iframe>
                            </div>
                        </div>
                    </div>
